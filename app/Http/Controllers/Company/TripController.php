...
class TripController extends Controller
{
    ...
    public function show(Trip $trip): View
    {
        ...
        return view('company.trips.show', compact('trip', 'onboardEmployees', 'replacementBuses', 'pendingTransferEmployees', 'expectedEmployees'));
    }
    ...
    public function report(Trip $trip): View
    {
        ...
        $report = app(TripReportService::class)->buildReport($trip, $this->companyId());

        return view('reports.trip', [
            'report' => $report,
            'trip' => $trip,
            'scope' => 'company',
            'routePrefix' => 'company.trips',
            'backUrl' => route('company.trips.show', $trip),
        ]);
    }
    ...
    public function exportReport(Request $request, Trip $trip, string $type)
    {
        ...
        $report = $service->buildReport($trip, $this->companyId());
