                            ...
                            <div class="d-flex flex-column h-100 py-0 py-xl-3">
                                            ...
                                            <div class="p-lg-5 p-4">
                                                <div>
                                                    <div class="text-center mt-1">
                                                        ...
                                                        <p class="text-muted">Sign in to continue to HyperionCore</p>
                                                    </div>
                                                    ...
                                                    <form method="POST" action="{{ route('login') }}" class="auth-input">
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <input id="email" type="email"
                                                                ...
                                                                name="email" value="{{ old('email', 'admin@system.test') }}" required
                                ...
                                <div class="mt-5 text-center">
                                    <p class="mb-0">©
                                        ...
                                        </script> HyperionCore Crafted with <i
                                            class="mdi mdi-heart text-danger"></i> Hyperion Core OPC
                                    </p>
                                </div>
                            </div>
                        </div>
