...
<script>
$(function () {
    const busJsonUrlTemplate = "{{ request()->routeIs('company.*') ? route('company.buses.json', ['bus' => '__BUS__']) : route('admin.buses.json', ['bus' => '__BUS__']) }}";
    ...
    $(document).on('click', '.btn-view-bus', function () {
        ...
        $.getJSON(busJsonUrlTemplate.replace('__BUS__', busId))
            .done(function (bus) {
