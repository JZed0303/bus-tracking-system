...
/* =========================================================
   ...
   INDIGO MINIMAL VARIANT (Drop-in)
   ========================================================= */

/* -------------------------------
   1) Brand Tokens (Indigo Palette)
--------------------------------- */
:root{
  /* Core Brand */
  --hm-primary: #4F46E5;      /* indigo */
  --hm-primary-2: #4338CA;    /* indigo hover */
  --hm-accent: #A5B4FC;       /* soft indigo */
  --hm-accent-2: #C7D2FE;     /* lighter accent */
  ...
  --hm-shadow-sm: 0 6px 18px rgba(0, 0, 0, 0.04);
  ...
  /* Focus ring */
  --hm-ring: 0 0 0 4px rgba(79, 70, 229, 0.15);

  /* Gradients */
  --hm-grad: linear-gradient(135deg, #4F46E5 0%, #A5B4FC 75%);
  --hm-grad-soft: linear-gradient(135deg, rgba(79, 70, 229, 0.08) 0%, rgba(165, 180, 252, 0.08) 100%);
}
...
.sidebar-user-box.mm-active{ background: rgba(79,70,229,0.08); }
.sidebar-user-box{
...
.hm-kpi-card{
  ...
  color: #fff !important;
  background: linear-gradient(135deg, #111827 0%, #4F46E5 62%, #A5B4FC 130%) !important;
...
<script>
  (function () {
    ...
    function applyApexThemeDefaults() {
      var palette = [
        cssVar('--hm-apex-1', '#4F46E5'),
        cssVar('--hm-apex-2', '#A5B4FC'),
        cssVar('--hm-apex-3', '#C7D2FE'),
        cssVar('--hm-apex-4', '#4338CA'),
