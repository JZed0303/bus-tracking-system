...
/* =========================================================
   ...
   GREEN SHADE VARIANT (Drop-in)
   ========================================================= */

/* -------------------------------
   1) Brand Tokens (Green Palette)
--------------------------------- */
:root{
  /* Core Brand */
  --hm-green: #15803D;        /* primary green */
  --hm-green-2: #166534;      /* deeper green for hover */
  --hm-lime: #22C55E;         /* accent lime */
  --hm-mint: #4ADE80;         /* accent mint */
  ...
  /* Focus ring */
  --hm-ring: 0 0 0 4px rgba(34, 197, 94, 0.18);

  /* Gradients */
  --hm-grad: linear-gradient(135deg, var(--hm-green) 0%, var(--hm-lime) 65%, var(--hm-mint) 120%);
  --hm-grad-soft: linear-gradient(135deg, rgba(21, 128, 61, 0.10) 0%, rgba(34, 197, 94, 0.10) 60%, rgba(74, 222, 128, 0.10) 120%);
}
...
/* -------------------------------
   4) Sidebar (make it HM green)
--------------------------------- */
.vertical-menu,
.navbar-brand-box,
.sidebar-menu-scroll,
.metismenu{
  background: linear-gradient(to bottom, #14532D 0%, #166534 48%, #052E16 100%) !important;
}
...
body[data-sidebar=colored].vertical-collpsed .vertical-menu #sidebar-menu>ul>li:hover>a{
  background-color: #0F4D24 !important;
}
...
.btn-soft-primary:hover{
  background: var(--hm-green-2) !important;
  border-color: var(--hm-green-2) !important;
}
...
.btn-outline-primary{
  color: var(--hm-white) !important; /* NOTE: bootstrap var; keep if defined in theme */
...
/* Secondary action uses lime */
.btn-warning{
  background: var(--hm-lime) !important;
  border-color: var(--hm-lime) !important;
  color: #fff !important;
}
.btn-warning:hover{
...
.hm-kpi-card{
  ...
  color: #fff !important;
  background: linear-gradient(135deg, #14532D 0%, #22C55E 65%, #4ADE80 120%) !important;
  box-shadow: 0 10px 24px rgba(21, 128, 61, 0.28) !important;
  position: relative;
  overflow: hidden;
}
...
<script>
  (function () {
    ...
    function applyApexThemeDefaults() {
      var palette = [
        cssVar('--hm-apex-1', '#15803D'),
        cssVar('--hm-apex-2', '#22C55E'),
        cssVar('--hm-apex-3', '#4ADE80'),
        cssVar('--hm-apex-4', '#166534'),
