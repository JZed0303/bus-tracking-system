                            ...
                            <table class="table table-hover table-nowrap align-middle mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>SimonRyles@HyperionCorecom</td>
                                        <td>125</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>MarionWalker@HyperionCorecom</td>
                                        <td>523</td>
                                        <td>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item">
                                    ...
                                    <tr>
                                        ...
                                        <td>FrederickWhite@HyperionCorecom</td>
                                        <td>234</td>
                                        <td>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item">
                                    ...
                                    <tr>
                                        ...
                                        <td>ShanonMarvin@HyperionCorecom</td>
                                        <td>412</td>
                                        <td>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item">
                                    ...
                                    <tr>
                                        ...
                                        <td>Frontend Developer</td>
                                        <td>MarkJones@HyperionCorecom</td>
                                        <td>852</td>
                                        <td>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item">
                                    ...
                                    <tr>
                                        ...
                                        <td>Backend Developer</td>
                                        <td>JaniceMorgan@HyperionCorecom</td>
                                        <td>657</td>
                                        <td>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item">
                                    ...
                                    <tr>
                                        ...
                                        <td>UI/UX Designer</td>
                                        <td>PatrickPetty@HyperionCorecom</td>
                                        <td>756</td>
                                        <td>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item">
                                    ...
                                    <tr>
                                        ...
                                        <td>Backend Developer</td>
                                        <td>MarilynHorton@HyperionCorecom</td>
                                        <td>425</td>
                                        <td>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item">
                                    ...
                                    <tr>
                                        ...
                                        <td>Full Stack Developer</td>
                                        <td>NealWomack@HyperionCorecom</td>
                                        <td>524</td>
                                        <td>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item">
                                    ...
                                    <tr>
                                        ...
                                        <td>Frontend Developer</td>
                                        <td>Steven Williams@HyperionCorecom</td>
                                        <td>762</td>
                                        <td>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item">
